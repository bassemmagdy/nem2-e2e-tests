...
export const s = {
    //Common elements
    password_form_field: ".row-75-25 > .ivu-tooltip > .ivu-tooltip-rel > .input-size",
    fee_selector: ".label-and-select > .select-size > .ivu-select-selection > div > .ivu-select-selected-value",
    ...
    network_type_selector: ".ivu-select-selected-value",
    password_create_acc_field: ":nth-child(4) > .form-row-inner-container > .inputs-container",
    confirm_password_create_acc_filed: ":nth-child(5) > .form-row-inner-container > .inputs-container",
    mnemonic_field: ".show-mnemonic",
    balance_address_to_interact: ":nth-child(1) > .table-item > .address-balance",
    first_address: ":nth-child(1) > .table-item > .address-value",
    second_address: ":nth-child(2) > .table-item > .address-value",
    third_address: ":nth-child(3) > .table-item > .address-value",
    fourth_address: ":nth-child(4) > .table-item > .address-value",
    balance_selected_account: ":nth-child(1) > .address-item > .table-item-content > .balance-row > .row > :nth-child(2)",
    accept_checkbox: ".ivu-checkbox-input",

    //Home page
    send_tab: ".tabs > :nth-child(2)",
    to_field: ":nth-child(2) > .inputs-container > .ivu-tooltip > .ivu-tooltip-rel > .input-size",
    mosaic_amount_field: ".row-mosaic-attachment-input > .inputs-container > .ivu-tooltip > .ivu-tooltip-rel > .input-style",
    message_textarea: ".textarea-size",
    encrypt_message_textbox: ".ivu-checkbox-input",
